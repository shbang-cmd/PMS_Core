...
앞서 소개한 김부장 포트폴리오의 변동성을 한 번 정량적으로 분석해보자. 아래 그래프는 최근 약 170개월 정도 매월 ETF별로 수익률을 분석해 본것이다.
...
아래는 제미나이 생성형 AI 인공지능이 작성한 실제 이메일 본문이다.
