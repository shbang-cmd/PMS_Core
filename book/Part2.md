...
사람들은 흔히 현금을 들고 있으면 “투자하지 않는 돈”, 혹은 “수익을 포기한 돈”이라고 말하곤 하지만, 투자라는 세계에서 현금이 갖는 의미는 그보다 훨씬 깊고, 훨씬 전략적이며, 무엇보다도 인간의 심리와 시간의 흐름을 함께 고려할 때 비로소 이해되는 성격을 띤다. 나는 포트폴리오를 설계할 때, 수익률의 최대화보다 먼저 “이 포트폴리오를 내가 끝까지 들고 갈 수 있는가”라는 질문을 던졌고, 그 질문은 결국 현금의 존재를 단순한 잔여물이 아니라 하나의 장치로 바라보게 만들었다.

이번 실험은 그 장치를 숫자로 확인하기 위한 과정이었다. 2012년부터 오늘까지의 장기 구간을 대상으로, SPY 100% 단일 투자와 내가 설계한 포트폴리오를 비교하되, 여기서 중요한 변수를 하나 추가했다. 바로 “현금을 일정 비율로 보유한다면, 그 현금은 성과와 위험을 어떻게 바꿔놓는가”라는 질문이다. 그래서 나는 포트폴리오를 100% 투자한 기본형(PORT_CASH0)에서 시작해, 현금 3%, 5%, 7%를 각각 떼어내는 시나리오(PORT_CASH3/5/7)를 만들어 같은 기간 동안의 연환산 수익률, 변동성, 샤프비율, 최대낙폭(MDD)을 일괄적으로 계산했다. 그리고 이때 현금은 아무런 수익도 내지 않는다고 가정했다. 말하자면 “이 돈은 이자를 받기 위한 돈이 아니라, 순수하게 쉬고 있는 돈”으로 설정한 것이다. 현실에서는 KOFR이나 BIL 같은 현금성 자산이 이자를 제공하겠지만, 나는 오히려 더 보수적인 조건을 깔아두고도 현금의 의미가 성립하는지를 확인하고 싶었다. 수익이 0%인 현금조차도 포트폴리오에 도움이 된다면, 그것은 단순한 편의가 아니라 구조적인 이점이기 때문이다.
